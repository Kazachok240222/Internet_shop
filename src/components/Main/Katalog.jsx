...
const Katalog = () => {
    return (
        <div className = 'Katalog'>
            <Header />
            <p className = 'zag'>Блузки и рубашки для женщин</p>
        ...
        <button className='podrobnee'>Подробнее<svg xmlns="http://www.w3.org/2000/svg" width="26" height="4" viewBox="0 0 26 4" fill="none">
